...
WSGI_APPLICATION = 'crm_ai_pro.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='crm_ai_pro'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CRM AI PRO API',
    'DESCRIPTION': 'Enterprise AI-Powered Multi-Tenant CRM SaaS Platform',
    'VERSION': '1.0.0',
